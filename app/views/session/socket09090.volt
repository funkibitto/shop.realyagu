...
<style>
  ...
  <a href="index.html">RabbitMQ Web STOMP Examples</a> > Temporary Queue</h1>
    ...
    $( function() {
      ...
      var secCode = $('#second div');
      client.debug = function(e) {
    	  secCode.append($("<code>").text(e));
      };
      ...
      client.connect('guest', 'guest', on_connect, on_error, '/test');
